  ...
  return (
    <div>
      <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
        <h1 className='text-slate-700 text-4xl lg:text-6xl font-bold dark:text-slate-200'>Welcome to my Blog</h1>
        ...
        <Link to={'/search'} className='text-xs sm:text-sm text-teal-700 font-bold hover:underline'>
          View all posts
        </Link>
      </div>
